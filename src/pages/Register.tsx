...
import { Calendar, Eye, EyeOff, Mail, Lock, User, GraduationCap, Building2 } from 'lucide-react';
      ...
      >
        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center gap-2">
            ...
            <span className="text-2xl font-bold text-navy-900">Evently</span>
          </Link>
        </div>

        <Card className="border-navy-100">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl text-navy-900">Create an account</CardTitle>
            <CardDescription className="text-navy-500">
              Sign up to start discovering and hosting events
            </CardDescription>
          </CardHeader>
          <CardContent>
            {/* User Type Toggle */}
            <div className="flex gap-2 mb-6 p-1 bg-navy-100 rounded-lg">
              <button
                type="button"
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="name" className="text-navy-700">Full Name</Label>
              ...
              {userType === 'student' && (
                <div className="space-y-2">
                  <Label htmlFor="university" className="text-navy-700">University</Label>
                  <div className="relative">
                    <GraduationCap className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-navy-400" />
                    <Input
                      id="university"
                      type="text"
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 pr-10 border-navy-200"
                    required
                    minLength={8}
                  />
                  <button
              ...
              <div className="flex items-start gap-2">
                <Checkbox
                  ...
                  className="mt-1"
                />
                <Label htmlFor="terms" className="text-sm font-normal leading-relaxed text-navy-600">
                  I agree to the{' '}
            ...
            <div className="mt-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-white text-navy-500">
                    Or continue with
                  </span>
                </div>
              </div>
              ...
              <div className="mt-6 grid grid-cols-2 gap-3">
                <Button variant="outline" className="w-full border-navy-200">
